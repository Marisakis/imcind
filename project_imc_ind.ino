...
//tasks that animates a block bouncing on the screen as well as screen updates
...
void setup() {
  ...
  addMenuOption(menu);
  //menu[0] = "No"; //Compiler error prevents deliberate changing of read only memory
  ...
  for (;;)
  {
    ...
    if (i2c_handle != NULL)
    {
...

      {
        ...
        {
          setLCDLine(1, getCurrentMenuText());
          //LcdText[1] = getCurrentMenuText();
          //  updateLCD(getCurrentMenuText());
